...
export function EvIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BikeIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M15 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-3 11.5 3.5-7.5H12L9.5 6H6" />
      <path d="m12 17.5 4-4.5" />
    </svg>
  )
}

export function TruckIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AccessibleIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="m10 8.5 2 4.5h4" />
      <path d="m10 8.5-3 5.5h3.5l1.5 5.5h4" />
      <path d="M5 19a5 5 0 0 1 5-5" />
    </svg>
  )
}
...
export function SnapIcon({ className = '', size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BlueprintIcon({ className = '', size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function EyeOffIcon({ className = '', size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function CopyIcon({ className = '', size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function UserIcon({ className = '', size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LockIcon({ className = '', size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShieldIcon({ className = '', size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LogOutIcon({ className = '', size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
